...
#   # are 1-indexed. Note we are passed an Arel not any results yet
#   #
...
#   # Wrapper class to access information from a kaminari-paginated result set.
#   # Augments kaminari pagination attributes with custom ones.
#   #
#   # Example use:
#   #
